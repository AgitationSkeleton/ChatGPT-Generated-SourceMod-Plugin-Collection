/**
 * TF2 December Trees (ctf_2fort5_v2)
...
{
    name        = "TF2 December Trees (ctf_2fort5_v2)",
    author      = "ChatGPT",
    description = "Spawns 2 Christmas tree props on ctf_2fort5_v2 during December (or forced) and adds required downloads.",
...
bool ShouldRunNow()
{
    ...
    if (!StrEqual(mapName, "ctf_2fort5_v2", false))
    {
        return false;
    }
...
void SpawnTrees_FixedCoords()
{
    ...
    float origins[2][3] =
    {
        { -1069.039551, -2819.480957, -95.468681 },
        {  1041.163818, 2822.531250, -95.468681 }
    };
