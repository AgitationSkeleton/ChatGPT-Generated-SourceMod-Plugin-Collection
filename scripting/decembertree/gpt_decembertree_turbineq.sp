...
{
    name        = "TF2 December Trees (ctf_turbine_q)",
    author      = "ChatGPT",
    description = "Spawns 2 Christmas tree props on ctf_turbine_q during December (or forced) and adds required downloads.",
...
bool ShouldRunNow()
{
    ...
    if (!StrEqual(mapName, "ctf_turbine_q", false))
    {
        return false;
    }
...
void SpawnTrees_FixedCoords()
{
    ...
    float origins[2][3] =
    {
        { -3092.319336, -982.657471, 32.031319 },
        {  3090.846924, 979.334290, 32.031319 }
    };
