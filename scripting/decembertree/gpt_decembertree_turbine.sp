...
{
    name        = "TF2 December Trees (ctf_turbine)",
    author      = "ChatGPT",
    description = "Spawns 2 Christmas tree props on ctf_turbine during December (or forced) and adds required downloads.",
...
bool ShouldRunNow()
{
    ...
    if (!StrEqual(mapName, "ctf_turbine", false))
    {
        return false;
    }
