...
public Plugin myinfo =
{
    ...
    author = "ChatGPT",
    description = "Forces all func_doors in qualifying maps to stay open every 30 seconds",
    version = "1.1",
    url = "N/A"
};
...
public void OnPluginStart()
{
    ...
    CreateTimer(5.0, Timer_OpenDoors, _, TIMER_REPEAT);
}
...
void UpdateMapEnabledState()
{
    ...
    // Only enable on maps whose name contains both "2mctf" and "tdc".
    g_bEnabled = (StrContains(mapName, "2mctf", false) != -1 && StrContains(mapName, "tdc", false) != -1);
}
