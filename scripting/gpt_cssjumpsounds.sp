 ...
 *
 * Game: Counter-Strike: Source (SDK2013/OrangeBox)
...
#define PLUGIN_NAME        "CSS Jump VO"
...
{
    g_hCookieHear = RegClientCookie("css_jumpvo_hear", "CSS Jump VO per-client hearing preference (1=on,0=off)", CookieAccess_Public);
