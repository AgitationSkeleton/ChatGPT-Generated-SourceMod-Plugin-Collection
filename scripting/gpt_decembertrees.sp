...
{
    name        = "TF2 December Trees (secret_facility)",
    author      = "ChatGPT",
    description = "Spawns 3 Christmas tree props on secret_facility during December (or forced) and adds required downloads.",
...
bool ShouldRunNow()
{
    ...
    if (!StrEqual(mapName, "secret_facility", false))
    {
        return false;
    }
...
void SpawnTrees_FixedCoords()
{
    ...
    float origins[3][3] =
    {
        { 10.167738,    160.706451,  -26.0 },
        { -1446.522095, 81.065987,   -26.0 },
        { 1459.591675,  115.448364,  -26.0 }
    };
